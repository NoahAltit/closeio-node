...
var Closeio = function(apiKey) {
  ...
  this.lead = {
    search: function(options) {
      ...
      console.log("FROM LINE 37 - PARAMETERS", parameters)
      console.log("FROM LINE 38 - OPTIONS", options)
...
Closeio.prototype._request = function(options) {
  ...
  request(options, function (error, response, body) {
    console.log("FROM LINE 283 - RESPONSE: ", response)
  ...
  console.log("FROM LINE 300 - OPTIONS: ", options)
  console.log("FROM LINE 301 - DEFFERED: ", d)
  return d.promise;
};
